...
import { TextField, Button, Card, CardContent, Typography, MenuItem, FormControl, Select, InputLabel } from '@mui/material';
...
const BookingPage = () => {
  ...
  return (
    <div style={{
      ...
      <Typography variant="h2" sx={{ fontWeight: 'bold', marginBottom: 4, textAlign: 'center', color: '#2C2C2C' }}>
        Book Room
      </Typography>
      <Card sx={{ maxWidth: '600px', padding: 4, borderRadius: 2, boxShadow: 3 }}>
        <CardContent>
